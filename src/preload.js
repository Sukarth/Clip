...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    getThemePaths: () => ipcRenderer.invoke('get-theme-paths'),
    openThemeConfigFile: () => ipcRenderer.invoke('open-theme-config-file'),
    getSettingsPaths: () => ipcRenderer.invoke('get-settings-paths'),
    openSettingsConfigFile: () => ipcRenderer.invoke('open-settings-config-file'),
    reloadSettingsFromDisk: () => ipcRenderer.invoke('reload-settings-from-disk'),
    getSettings: () => ipcRenderer.invoke('get-settings'),
    getStartupNotices: () => ipcRenderer.invoke('get-startup-notices'),
    unpinAllItems: () => ipcRenderer.invoke('unpin-all-items'),
